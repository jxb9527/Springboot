...
import cn.et.lesson2.entity.EmpExample.Criteria;
import cn.et.lesson2.entity.EmpExample.Criterion;
...
public class EmpSqlProvider {
    ...
    public String insertSelective(Emp record) {
        ...
        if (record.getEsal() != null) {
            sql.VALUES("esal", "#{esal,jdbcType=DECIMAL}");
        }
    ...
    public String updateByExampleSelective(Map<String, Object> parameter) {
        ...
        if (record.getEsal() != null) {
            sql.SET("esal = #{record.esal,jdbcType=DECIMAL}");
        }
    ...
    public String updateByPrimaryKeySelective(Emp record) {
        ...
        if (record.getEsal() != null) {
            sql.SET("esal = #{esal,jdbcType=DECIMAL}");
        }
